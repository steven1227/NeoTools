...
(function (App) {
    ...
    [
        ...
        "(int)100"
            ...
            div.appendChild(document.createElement("br"));
            btn_ok.onclick = () => __awaiter(this, void 0, void 0, function* () {
                try {
                    let data;
                    ...
                    if (input_scHash.value != "") {
                        const ps = JSON.parse(text_scParams.value);
                    ...
                    if (extdata.gas > Neo.Fixed8.Zero) {
                        ...
                        tran.inputs = new Array(0);
                        tran.outputs = new Array(0);
    ...
    App.CreateUnSignTx = CreateUnSignTx;
    window.onload = () => {
        const cm = new CreateUnSignTx();
        cm.start();
    };
})(App || (App = {}));
//# sourceMappingURL=createUnSignTx.js.map